// function loadFile(){
//   loadStrings("Article3text.txt", fileLoaded)
// }
...
function preload() {
  articleLines = loadStrings('Article3text.txt');
  img = loadImage('Article3_image.jpg');
  for (let i =0; i < 4; i++){
    pics[i] = loadImage('arts/art'+ i + '.jpg');
  }
}
function setup() {
  ...
  song = loadSound("Article3.mp3", loaded);
