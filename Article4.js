// function loadFile(){
//   loadStrings("Article4text.txt", fileLoaded)
// }
...
function preload() {
  articleLines = loadStrings('Article4text.txt');
  img = loadImage('Article4_image.jpg');
  for (let i =0; i < 3; i++){
    pics[i] = loadImage('words/word'+ i + '.jpg');
  }
}
function setup() {
  ...
  song = loadSound("Article4.mp3", loaded);
